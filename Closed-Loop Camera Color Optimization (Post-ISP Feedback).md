...
- ISP: It is a device-specific processing pipeline that transforms raw sensor data into standardized color spaces (e.g., sRGB, P3) and perceptually accurate images using methods like AWB, CCM, and CLUT.
